      ...
      switch (name) {
        ...
        case "pl_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "UOKiK (Urzad Ochrony Konkurencji i Konsumentow — Polish Office of Competition and Consumer Protection) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the Ustawa o ochronie konkurencji i konsumentow.",
